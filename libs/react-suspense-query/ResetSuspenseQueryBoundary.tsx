...
import { AsyncBoundary } from '../react-boundary';
...
const ResetSuspenseQueryBoundary = BaseResetSuspenseQueryBoundary as ResetSuspenseQueryBoundaryType;

type SSROrCSRProps = Omit<ComponentProps<typeof BaseResetSuspenseQueryBoundary>, 'ssrSafe'>;

ResetSuspenseQueryBoundary.SSRSafe = forwardRef<ResetRef, SSROrCSRProps>(function SSRSafeResetSuspenseQueryBoundary(
  props,
  resetRef
) {
...
ResetSuspenseQueryBoundary.CSRSafe = forwardRef<ResetRef, SSROrCSRProps>(function SSRSafeResetSuspenseQueryBoundary(
  props,
  resetRef
) {
